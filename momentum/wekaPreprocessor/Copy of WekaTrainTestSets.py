import csv
def CreateTrainingSetForWekaForSymbol(symbol, beta, marketValue, train, test, isFirstSymbol):
...
#    os.mkdir("data/weka")
    ...
    while symbols:
        ...
        CreateTrainingSetForWekaForSymbol(symbol, beta[symbol], marketValue[symbol], train, test, isFirstSymbol)
        isFirstSymbol = 0
