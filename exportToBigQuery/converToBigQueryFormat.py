...
def yahooQuotes():
    ...
    outputfile = open('../../exportData/yahooQuotes.json.bigquery', 'w')
...
def symbols():
    ...
    outputfile = open('../../exportData/symbols.json.bigquery', 'w')
...
def ratingsChanges():
    ...
    outputfile = open('../../exportData/ratingsChanges.json.bigquery', 'w')
...
def fundamentals():
    ...
    outputfile = open('../../exportData/fundamentals.json.bigquery', 'w')
...
def form4():
    ...
    outputfile = open('../../exportData/form4.json.bigquery', 'w')
